class SetPrimaryKeyOnJoinTables < ActiveRecord::Migration[7.0]
  def up
    safety_assured do
      ...
      add_index :motifs_plage_ouvertures, [:motif_id, :plage_ouverture_id], unique: true, name: :index_motifs_plage_ouvertures_primary_keys
  ...
  def down
    safety_assured do
      ...
      remove_index :motifs_plage_ouvertures, [:motif_id, :plage_ouverture_id], name: :index_motifs_plage_ouvertures_primary_keys
